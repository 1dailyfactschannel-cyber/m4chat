...
export function ContactsScreen() {
  const contacts = [
    ...
    { id: 2, name: "Andrew", phone: "был(а) недавно", avatar: "bg-orange-500", initials: "A", online: false, letter: "A" },
    { id: 3, name: "Bob Smith", phone: "был(а) 2 мин. назад", avatar: "bg-green-500", initials: "BS", online: false, letter: "B" },
    { id: 4, name: "Charlie", phone: "+1 (555) 987-6543", avatar: "bg-purple-500", initials: "C", online: false, letter: "C" },
    { id: 5, name: "Chris", phone: "в сети", avatar: "bg-teal-500", initials: "C", online: true, letter: "C" },
    { id: 6, name: "David", phone: "был(а) вчера", avatar: "bg-blue-500", initials: "D", online: false, letter: "D" },
    ...
    { id: 9, name: "Zack", phone: "был(а) недавно", avatar: "bg-yellow-500", initials: "Z", online: false, letter: "Z" },
  ];
  ...
  return (
    <div className="w-[390px] h-[844px] bg-white overflow-hidden flex flex-col relative" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="flex justify-between items-center px-4 py-2 bg-white border-b border-[#E5E5EA] z-10">
        ...
        <h1 className="text-[20px] font-semibold text-[#1C1C1E]">Контакты</h1>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[83px] bg-white border-t border-[#E5E5EA] flex justify-between px-6 pt-2 pb-8 z-10">
        <button className="flex flex-col items-center gap-1 text-[#8E8E93]">
          ...
          <span className="text-[10px] font-medium">Звонки</span>
        </button>
        <button className="flex flex-col items-center gap-1 text-[#8E8E93]">
        ...
        <button className="flex flex-col items-center gap-1 text-[#2481CC]">
          ...
          <span className="text-[10px] font-medium text-[#2481CC]">Контакты</span>
        </button>
        <button className="flex flex-col items-center gap-1 text-[#8E8E93]">
