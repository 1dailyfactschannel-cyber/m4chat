    ...
    <div style={{ width: '1280px', height: '800px', display: 'flex', overflow: 'hidden', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="w-[340px] shrink-0 bg-[#FFFFFF] border-r border-[#EDEDED] flex flex-col relative">
        ...
        <div className="h-[60px] flex items-center justify-between px-4 shrink-0">
          <h1 className="font-semibold text-[16px] text-[#1C1C1E]">Контакты</h1>
        ...
        <div className="flex-1 overflow-y-auto pr-6">
          ...
          {[
            { letter: "A", items: [
              ...
              { name: "Andrew Smith", info: "был(а) недавно", avatar: "AS", color: "from-blue-400 to-blue-600", online: false, active: false }
            ]},
            { letter: "B", items: [
              { name: "Bob Martin", info: "был(а) в 10:45", avatar: "BM", color: "from-green-400 to-green-600", online: false, active: false },
              { name: "Brenda Lee", info: "был(а) вчера", avatar: "BL", color: "from-purple-400 to-purple-600", online: false, active: false }
            ]},
            { letter: "C", items: [
              { name: "Charlie Davis", info: "в сети", avatar: "CD", color: "from-orange-400 to-orange-500", online: true, active: false }
            ]},
            { letter: "D", items: [
              { name: "David Wilson", info: "был(а) недавно", avatar: "DW", color: "from-red-400 to-red-600", online: false, active: false },
              { name: "Diana Prince", info: "был(а) неделю назад", avatar: "DP", color: "from-pink-400 to-pink-500", online: false, active: false }
            ]},
          ].map((section, idx) => (
            <div key={idx}>
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center">
          <div className="w-full max-w-xl bg-white rounded-2xl shadow-sm border border-[#EDEDED] overflow-hidden">
            ...
            <div className="p-8 flex flex-col items-center border-b border-[#EDEDED]">
              ...
              <p className="text-[#8E8E93] text-[15px] mb-6">в сети</p>
              ...
              <div className="flex gap-3 w-full justify-center">
                <button className="flex flex-col items-center justify-center gap-2 w-24 h-20 rounded-xl hover:bg-[#F1F1F1] text-[#2481CC] transition-colors">
                  ...
                  <span className="text-[13px] font-medium">Сообщение</span>
                </button>
                <button className="flex flex-col items-center justify-center gap-2 w-24 h-20 rounded-xl hover:bg-[#F1F1F1] text-[#2481CC] transition-colors">
                  <div className="bg-[#E8F4FF] p-3 rounded-full">
                    <Phone className="w-5 h-5" />
                  </div>
                  <span className="text-[13px] font-medium">Звонок</span>
                </button>
                <button className="flex flex-col items-center justify-center gap-2 w-24 h-20 rounded-xl hover:bg-[#F1F1F1] text-[#2481CC] transition-colors">
                  <div className="bg-[#E8F4FF] p-3 rounded-full">
                    <Video className="w-5 h-5" />
                  </div>
                  <span className="text-[13px] font-medium">Видео</span>
                </button>
              </div>
            </div>
