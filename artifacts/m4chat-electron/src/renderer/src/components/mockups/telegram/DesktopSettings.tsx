    ...
    <div style={{ width: '1280px', height: '800px', display: 'flex', overflow: 'hidden', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="w-[340px] shrink-0 bg-[#FFFFFF] border-r border-[#EDEDED] flex flex-col">
        ...
        <div className="h-[60px] flex items-center px-4 shrink-0">
          <h1 className="font-semibold text-[16px] text-[#1C1C1E]">Настройки</h1>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-2">
          {[
            { icon: Settings, label: "Мой аккаунт", active: true },
            { icon: Bell, label: "Уведомления", active: false },
            { icon: Shield, label: "Конфиденциальность", active: false },
            { icon: Database, label: "Данные и хранилище", active: false },
            { icon: Palette, label: "Оформление", active: false },
            { icon: Globe, label: "Язык", active: false, extra: "Русский" },
            { icon: Star, label: "m4chat Premium", active: false, color: "text-[#8B5CF6]" },
            { icon: Monitor, label: "Устройства", active: false, extra: "3" },
          ].map((item, i) => (
